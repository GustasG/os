...
public class Constants {
    ...
    public static final int DATA_SEGMENT_SIZE = 5 * PAGE_SIZE;
    public static final int CODE_SEGMENT_START = 5 * PAGE_SIZE;
    public static final int CODE_SEGMENT_SIZE = 7 * PAGE_SIZE;
    public static final int STACK_SEGMENT_START = 12 * PAGE_SIZE;
    public static final int STACK_SEGMENT_SIZE = 4 * PAGE_SIZE;
}